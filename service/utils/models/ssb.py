...
class SSB(object):
    def __init__(self):
        ...
        self.collection_name = 'ssb'  # collection name
        ...
        self.create_required_fields = ["reading", "location"]
    ...
    def find(self, ssb_data):  # find all
        return self.db.find(ssb_data, self.collection_name)
