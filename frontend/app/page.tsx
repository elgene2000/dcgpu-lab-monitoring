...
export default function Home() {
  ...
  return (
    <main className="items-center max-w-7xl w-full mx-auto min-h-screen p-8 pb-20 sm:p-20">
      <p className="text-xl font-bold text-left flex flex-col pb-3">Home</p>
      <div className="flex w-full space-x-3">
        <div className="flex flex-col items-start space-y-3 w-5/6">
          <Card className="w-full p-2">
            ...
            <div className="mx-auto w-60 h-96 items-center justify-center">
              <Image alt="wip" src={theme=="dark" ? "/work-in-progress.png" : ""} width={200} height={200} className="opacity-40 " />
            </div>
          </Card>
