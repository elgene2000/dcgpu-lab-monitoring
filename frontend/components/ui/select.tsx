...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-9 w-full items-center justify-between whitespace-nowrap rounded-md bg-slate-100 dark:bg-[#272D3C] border dark:border-dark-sidebar-border border-slate-200 dark: px-3 py-2 text-sm data-[placeholder]:text-slate-500 focus:outline-none disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1 dark:data-[placeholder]:text-slate-400",
      className
    )}
    {...props}
  >
